...
typedef vector<list<Edge> > AdjGraph;
typedef vector<list<Edge> >::iterator NodeIterator;
typedef vector<list<Edge> >::const_iterator ConstNodeIterator;
typedef list<Edge>::iterator EdgeIterator;
typedef list<Edge>::const_iterator ConstEdgeIterator;
